...
IFontDisp = Font
__all__ = [ 'OLE_YPOS_PIXELS', 'OLE_YPOS_HIMETRIC', 'FontEvents',
           'Font', 'OLE_YSIZE_HIMETRIC', 'IFont', 'OLE_OPTEXCLUSIVE',
           'LoadPictureConstants', 'FONTUNDERSCORE',
           'OLE_XSIZE_CONTAINER', 'StdPicture', 'FONTSTRIKETHROUGH',
           'OLE_TRISTATE', 'Gray', 'IPicture',
           'OLE_ENABLEDEFAULTBOOL', 'OLE_XSIZE_HIMETRIC', 'Default',
           'OLE_XPOS_HIMETRIC', 'OLE_YSIZE_CONTAINER', 'IFontDisp',
           'VgaColor', 'OLE_XPOS_PIXELS', 'IFontEventsDisp',
           'OLE_COLOR', 'Picture', 'OLE_XSIZE_PIXELS', 'FONTBOLD',
           'FONTNAME', 'FONTITALIC', 'Unchecked', 'OLE_HANDLE',
           'StdFont', 'OLE_YSIZE_PIXELS', 'Checked', 'Color',
           'FONTSIZE', 'OLE_XPOS_CONTAINER', 'OLE_YPOS_CONTAINER',
           'IPictureDisp', 'Monochrome', 'OLE_CANCELBOOL']
